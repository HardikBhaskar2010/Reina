        ...
        {showWelcome && (
          ...
          >
            <div className="glass-card rounded-2xl shadow-floating border border-pink-200/30 p-4 text-center max-w-sm mx-auto">
              <motion.div 
                className="w-10 h-10 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center mx-auto mb-3"
                animate={{ 
                  scale: [1, 1.2, 1],
                }}
                transition={{
              ...
              <button 
                ...
                className="mt-3 px-4 py-2 bg-primary/20 rounded-full text-xs text-primary font-medium hover:bg-primary/30 transition-colors"
